...
from .events import check_method, check_secret_key, on_start_bot, error_type_event, on_click_button, ask_the_bot
...
async def handle_bot_events(request: Request, secret_key: str, redis: redis.Redis = Depends(get_redis)):
